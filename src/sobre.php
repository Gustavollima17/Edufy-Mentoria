        ...
        <div class="container">
            ...
            <nav class="nav">
                <ul>
                    ...
                    <li><a href="/cadastro2.php" target="_blank" class="btn-signup">Cadastre-se</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <section class="testimonials">
        <div class="container">
            ...
            <div class="testimonials-container">
                ...
                <div class="testimonial">
                    <div class="testimonial-header">
                        <p class="testimonial-name">Marcos Albino</p>
                        <p class="testimonial-date">5 de dezembro de 2023</p>
                    </div>
                    <p class="testimonial-rating">⭐⭐⭐⭐⭐</p>
                    <p class="testimonial-text">
                        Minha segunda experiência com o SiriusProject foi tão incrível quanto a primeira. O mentor que me acompanhar dessa vez foi extremamente paciente e detalhista, e me ajudou a consolidar habilidades técnicas avançadas que eu estava buscando aprimorar. Recomendo a todos que queiram um desenvolvimento profissional de qualidade!
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="mentor-content">
                <div class="mentor-text">
                    <h2>Seja um mentor no <span class="highlight">Edufy de Mentoria</span></h2>
                    <p>Junte-se ao SiriusProject como mentor voluntário e faça a diferença na vida de jovens talentosos. Compartilhe suas habilidades e experiências e ajude a próxima geração a alcançar seu potencial máximo. Nossos mentores vêm de diversas áreas, mas todos têm um objetivo em comum: promover a igualdade de oportunidades.</p>
                    <button class="btn">Seja um mentor</button>
                </div>
                <div class="mentor-image">
                    <img src="https://www.youbilingue.com.br/blog/wp-content/uploads/2021/03/concentrated-young-people-reading-information-from-laptop-4.jpg" alt="Mentoria">
                </div>
            </div>
        </div>
    </section>   
